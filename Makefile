...
# Project:  wmvlc.pro
# Template: app
# Command: /usr/lib/qt6/bin/qmake6 -o Makefile wmvlc.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = wmvlc1.0.0
DISTDIR = /home/bartu/Desktop/projects/media-player/.tmp/wmvlc1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/lib -Wl,-rpath-link,/usr/lib
LIBS          = $(SUBLIBS) /usr/lib/libQt6Widgets.so /usr/lib/libQt6Gui.so /usr/lib/libGLX.so /usr/lib/libOpenGL.so /usr/lib/libQt6Core.so -L/usr/lib -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
main.moc: main.cpp \
	...
	/usr/lib64/qt6/libexec/moc $(DEFINES) --include /home/bartu/Desktop/projects/media-player/moc_predefs.h -I/usr/lib64/qt6/mkspecs/linux-g++ -I/home/bartu/Desktop/projects/media-player -I/usr/include/qt6 -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtCore -I/data/data/com.termux/files/usr/include/c++/v1 -I/data/data/com.termux/files/usr/lib/clang/21/include -I/data/data/com.termux/files/usr/include/aarch64-linux-android -I/data/data/com.termux/files/usr/include main.cpp -o main.moc
